        ...
        for attention in [True,False]:
            for use_id in [True,False]:
                for FOLD in range(1,5+1):
                    ...
                    with open(f"../working/1M_{use_id}_{FOLD}.pkl", 'wb') as file:
                        pickle.dump(net,file)

                    with open(f"../working/1M_{use_id}_{FOLD}_p.pkl", 'wb') as file:
                        pickle.dump(place_dict,file)
                    with open(f"../working/1M_{use_id}_{FOLD}_l.pkl", 'wb') as file:
