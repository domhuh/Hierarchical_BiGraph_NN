...
for version in ["alpha", "beta"]:
    ug, mg, rg, ux, mx, rx, y = load_data1M(version)
    ...
    with open("../working/100k_alpha_3.pkl",'rb') as file:
    ...
    with open(f"../working/1M_alpha_pretrained_v{version}.pkl", 'wb') as file:
        pickle.dump(alpha_model,file)

    #alpha

    with open("../working/100k_beta_3.pkl",'rb') as file:
    ...
    with open(f"../working/1M_beta_pretrained_v{version}.pkl", 'wb') as file:
